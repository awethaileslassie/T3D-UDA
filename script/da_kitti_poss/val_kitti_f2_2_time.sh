...
python test.py --config_path 'configs/data_config/da_kitti_poss/uda_kitti_poss_f2_2_time.yaml'  --mode 'val'  --save 'True' 2>&1 | tee logs_dir/${name}_uda_val_kitti_f2_2_time.txt
