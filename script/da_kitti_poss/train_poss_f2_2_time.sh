...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/T-UDA/logs/train_poss_f2_2_time_%j.log     # file name for stdout/stderr
# module
...
python train.py --config_path 'configs/data_config/poss/poss_f2_2_time.yaml' 2>&1 | tee logs_dir/${name}_logs_poss_f2_2_time.txt
