...
#SBATCH --gres=gpu:3
#SBATCH --mem=40G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/ST-UDA/logs/run_val_uda_wod_kitti_wod_f3_3_time_%j.log     # file name for stdout/stderr
# module
...
python test.py --config_path 'configs/data_config/da_wod_kitti/uda_wod_kitti_f3_3_time.yaml' --mode 'val' --challenge 'False' --save 'True' 2>&1 | tee logs_dir/${name}_logs_val_uda_wod_kitti_f3_3_time.txt
