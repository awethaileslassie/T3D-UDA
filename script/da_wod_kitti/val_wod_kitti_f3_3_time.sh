...
python test.py --config_path 'config/da_wod_kitti/uda_wod_kitti_f3_3_time.yaml' --mode 'val' --challenge 'False' --save 'True' 2>&1 | tee logs_dir/${name}_logs_val_uda_wod_kitti_f3_3_time.txt
