...
python test.py --config_path 'config/da_wod_kitti/uda_wod_kitti_f0_0_intensity.yaml' --mode 'val' --challenge 'False' --save 'True' 2>&1 | tee logs_dir/${name}_logs_val_uda_wod_kitti_f0_0_intensity.txt
