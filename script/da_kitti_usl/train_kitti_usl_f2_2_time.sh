...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/T-UDA/logs/dpp_train_uda_kitti_usl_f2_2_time_%j.log     # file name for stdout/stderr
# module
...
python train_uda.py --config_path 'configs/data_config/da_kitti_usl/uda_kitti_usl_f2_2_time.yaml' 2>&1 | tee logs_dir/${name}_logs_uda_kitti_usl_f3_3_time.txt
