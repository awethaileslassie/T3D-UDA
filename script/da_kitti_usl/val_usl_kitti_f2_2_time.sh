...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/T-UDA/logs/val_uda_usl_kitti_f2_2_time_%j.log     # file name for stdout/stderr
# module
...
python test.py --config_path 'configs/data_config/da_kitti_usl/uda_test_usl_kitti_f2_2_time.yaml'  --mode 'val' --challenge 'False' --save 'True' 2>&1 | tee logs_dir/${name}_logs_uda_val_usl_kitti_f2_2_time.txt
