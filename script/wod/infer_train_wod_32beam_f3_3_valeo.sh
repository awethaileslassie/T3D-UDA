...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/ST_Cylinder_3D/logs/wod_32beam_infer_train_f3_3_all_v3_2_valeo%j.log     # file name for stdout/stderr
# module
...
python test_cylinder_asym_wod.py --config_path 'config/wod/wod_32beam_f3_3_valeo.yaml' --mode 'test' --save 'True' 2>&1 | tee logs_dir/${name}_logs_wod_32beam_f3_3_infer_train_v3_2_valeo.txt
