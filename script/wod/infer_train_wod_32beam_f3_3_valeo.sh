...
python test_wod.py --config_path 'configs/wod/wod_32beam_f3_3_valeo.yaml' --mode 'test' --save 'True' 2>&1 | tee logs_dir/${name}_logs_wod_32beam_f3_3_infer_train_v3_2_valeo.txt
