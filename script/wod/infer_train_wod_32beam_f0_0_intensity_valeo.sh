...
python test_wod.py --config_path 'configs/wod/wod_f0_0_intensity_beam32.yaml' --mode 'test' --save 'True' 2>&1 | tee logs_dir/${name}_logs_wod_32beam_f0_0_intensity_infer_train_v3_2_valeo.txt
