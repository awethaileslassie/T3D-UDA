...
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/ST-UDA/logs/wod_train_f3_3_all_v3_2_intensity_beam32_%j.log     # file name for stdout/stderr
# module
...
python train.py --config_path 'configs/wod/wod_f3_3_intensity_beam32.yaml' 2>&1 | tee logs_dir/${name}_logs_wod_f3_3_b2_v3_2_intensity_beam32.txt
