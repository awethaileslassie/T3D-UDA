...
#SBATCH --time=10-04:00:0              # time limits: 500 hour
#SBATCH --partition=amdgpuextralong	  # gpufast
#SBATCH --gres=gpu:1
#SBATCH --mem=60G
#SBATCH --output=/home/gebreawe/Model_logs/Segmentation/ST-UDA/logs/wod_train_f3_3_intensity_all_v3_2_%j.log     # file name for stdout/stderr
# module
...
python train_wod.py --config_path 'configs/wod/wod_f3_3_intensity.yaml' 2>&1 | tee logs_dir/${name}_logs_wod_f3_3_intensity_v3_2_time.txt
