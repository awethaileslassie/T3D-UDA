...
def main():
    ...
    for i, sq in enumerate(sequence):
        ...
        for frame, data in enumerate(files):
            ...
            os.rename(os.path.join(source, sq, "velodyne", frame_data + '.bin'),
                      os.path.join(source, sq, "velodyne", frame_name + '.bin'))
            os.rename(os.path.join(source, sq, "labels", frame_data + '.label'),
                      os.path.join(source, sq, "labels", frame_name + '.label'))
